...
AS $$
DECLARE
  project_url TEXT := 'https://dxuyxchbenlplsdtukdx.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImR4dXl4Y2hiZW5scGxzZHR1a2R4Iiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTcwNzIwMDI1NCwiZXhwIjoyMDIyNzc2MjU0fQ.-Q_zKiJix5jCGWN0KhlVgqNuJ4yckMGqKBBGPdTUCkc'; -- full access needed for http request to storage
